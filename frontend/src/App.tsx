...
import { BubbleList, BubbleCreate, BubbleEdit } from './resources/Bubble';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a1e958be9">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          ...
          create={ScoreCreate}
          edit={ScoreEdit}
          recordRepresentation="currentScore"
          icon={ScoreIcon}
        />
